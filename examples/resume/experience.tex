  ...
  \cventry
    ...
    {Apr 2025 -- Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Delivered the file-over-memory project to the HQ platform team, managing the full lifecycle from research to final technology transfer}
        \item {Led code reviews and established quality standards, significantly accelerating performance verification and service stability}
      \end{cvitems}
    }
